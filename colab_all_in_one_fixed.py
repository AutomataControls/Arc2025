...
# Download ARC dataset - Using git clone
print("\n📥 Downloading ARC dataset...")
if not os.path.exists('training'):
    os.system("git clone https://github.com/arcprizeorg/2024-data-release.git")
    os.system("mv 2024-data-release/arc-agi/data/training .")
    os.system("mv 2024-data-release/arc-agi/data/evaluation .")
    os.system("rm -rf 2024-data-release")
...
# Quick training for testing - reduce epochs
QUICK_TEST = True  # Set to False for full training
epochs_dict = {
    'minerva': 3 if QUICK_TEST else 30,
    'atlas': 3 if QUICK_TEST else 25,
    'iris': 3 if QUICK_TEST else 25,
    'chronos': 3 if QUICK_TEST else 25,
    'prometheus': 3 if QUICK_TEST else 30
}
...
for model_name in ['minerva', 'atlas', 'iris', 'chronos', 'prometheus']:
    if model_name in detailed_metrics:
        ...
        print(f"{model_name.upper()}: {metrics['best_accuracy']*100:.1f}% accuracy")
